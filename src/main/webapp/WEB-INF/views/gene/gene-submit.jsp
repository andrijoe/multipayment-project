	...
	<div class="col-xl-12">
		<div class="card">
			...
			<div class="card-body">
				<div class="row">
					<div class="col-sm-10">
						<form action='<c:url value="/geneSubmit" />' enctype="multipart/form-data" class="form-horizontal" method="post">
							<div class="form-group">
								<label class="col-lg-4 control-label">Upload File Gene</label>
								<div class="col-lg-8">
									<input type="file" name="geneFile" class="form-control" placeholder="file format txt" />
								</div>
							</div>
							<div class="form-group">
								<div class="col-lg-8 col-lg-offset-4">
									<input type="submit" name="submitBtn" class="btn btn-primary btn-sm" value="Submit" />
									<a href="<c:url value='/gene' />" name="submitBtn" class="btn btn-default btn-sm">
										Cancel
									</a>
								</div>
							</div>
